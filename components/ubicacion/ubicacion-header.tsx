...
export function UbicacionHeader() {
  return (
    <View style={styles.header}>
      ...
      <Text style={styles.titulo}>Mi</Text>
      <Text style={styles.subtitulo}>Ubicación</Text>
      <Text style={styles.descripcion}>
        Obtené la ubicación actual del dispositivo usando GPS y permisos de
        localización. Útil en apps de turismo, transporte, delivery, seguridad o
        reportes ciudadanos.
      </Text>
    </View>
  );
