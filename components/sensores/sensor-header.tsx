...
export function SensorHeader() {
  return (
    <View style={styles.header}>
      ...
      <Text style={styles.titulo}>Sensor de</Text>
      <Text style={styles.subtitulo}>Movimiento</Text>
      <Text style={styles.descripcion}>
        Lectura en tiempo real del acelerómetro del dispositivo. Iniciá la captura para
        observar los ejes X, Y, Z y el estado interpretado del movimiento.
      </Text>
    </View>
  );
}
